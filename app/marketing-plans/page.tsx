      ...
      <div className="flex min-h-screen">
        <aside className="hidden w-56 shrink-0 border-r border-slate-200 bg-white xl:block">
          <div className="border-b border-slate-200 p-5">
            ...
            <div className="mt-1 text-lg font-semibold">营销计划</div>
          </div>
          <nav className="space-y-1 p-3 text-sm">
            {[
              ...
              <div key={label} className={`rounded-md px-3 py-2 ${label === "营销计划与事项" ? "bg-blue-50 text-blue-700" : "text-slate-500"}`}>
        ...
        <section className="min-w-0 flex-1 p-4 md:p-6">
          <div className="mb-4 text-sm text-slate-500">营销计划与事项 / 营销计划管理 / 3.7.9</div>
