      ...
      <div className="flex min-h-screen">
        <aside className="hidden w-56 shrink-0 border-r border-slate-200 bg-white xl:block">
          <div className="border-b border-slate-200 p-5">
            ...
            <div className="mt-1 text-lg font-semibold">基础数据</div>
          </div>
            ...
            {[
              ...
              <div
                ...
                className={`rounded-md px-3 py-2 ${
                  label === "基础数据" ? "bg-blue-50 text-blue-700" : "text-slate-500"
                }`}
              >
        ...
        <section className="min-w-0 flex-1 p-4 md:p-6">
          <div className="mb-4 text-sm text-slate-500">基础数据 / 主数据维护 / 3.7.1</div>
